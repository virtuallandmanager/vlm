...
import { registerJwt } from './middleware/auth'
...
import companionUploadRoutes from './routes/companion-upload'
import { startHookCrons } from './integrations/platform-hooks'
import { VLMSceneRoom } from './ws/VLMSceneRoom'
import { VLMCommandCenterRoom } from './ws/VLMCommandCenterRoom'
